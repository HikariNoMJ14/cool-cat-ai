...
class DurationBase(BaseModel):
    ...
    def __init__(self, dataset=None, logger=None, save_path=os.path.join(src_path, 'results'), **kwargs):
        super(DurationBase, self).__init__(dataset, logger, save_path, **kwargs)
        ...
        merge_nn_input_size = self.lstm_hidden_size
    ...
    def forward(self, features):
        ...
        past_improvised_lstm_input = self.prepare_past_lstm_input(features)
        past_improvised_lstm_hidden = self.init_hidden(batch_size=features.size(0))
